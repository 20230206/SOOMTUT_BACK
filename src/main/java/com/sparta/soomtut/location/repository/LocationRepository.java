...
public interface LocationRepository extends JpaRepository<Location, Long> {
    ...
    @Query("select new com.sparta.soomtut.dto.response.LocationResponseDto(l.address,l.vectorX,l.vectorY,m.nickname)  from Location l join Member m on l.member.id = m.id where l.address LIKE :myCityName%")
